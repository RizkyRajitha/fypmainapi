...
#numpy==1.19.5 > 1.22.1 
#pandas==0.24.2 > 1.3.5
#installed beautifulsoup4-4.9.3 googlesearch-python-1.0.1 requests-2.25.1 WITH googlesearch-python
## Issues
#"url":"http://chachainsurance.com/wp-admin/includes" -> 31
#"url":"https://secure.runescape.com-as.ru" -> 29
...
def predict():
    ...
    inputData = generate_data_set(X["url"])
    print(len(inputData))
    print(inputData)

    clf = joblib.load('model.pkl')

    results = clf.predict([inputData])

    data = {"result":int(results[0])}
